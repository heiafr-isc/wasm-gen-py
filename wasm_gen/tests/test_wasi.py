...
from wasm_gen import instructions as I  # noqa  # noqa
...
def test_wasi():
    ...
    target = Path(__file__).parent / "test_wasi.wasm"
    ...
    assert (
        sig.hexdigest()
        == "9cff86fdf1a926a54b5e374af189f658ea9381a5dd552fb39c2ca70424228992"
    )
